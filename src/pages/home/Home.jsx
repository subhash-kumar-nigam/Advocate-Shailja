...
const Home = () => {
  ...
  "
              ...
              <div className="hidden md:block absolute -bottom-4 -right-4 w-full h-full border-2 border-[#6366F1] rounded-2xl"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white relative">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <p className="text-sm sm:text-base text-gray-700 leading-relaxed border-l-2 sml:border-l-4 border-[#6366F1] pl-4">
              Advocate{" "}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid gap-6 md:grid-cols-3 mt-10">
            {[
              ...
              <div
                key={index}
                className="bg-white border border-[#6366F1] rounded-xl p-6 text-center shadow-md"
              >
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <h2 className="text-3xl md:text-4xl font-bold text-center">
            Practice <span className="text-[#6366F1]">Areas</span>
          </h2>
          ...
          <div className="grid gap-5 sm:grid-cols-2 md:grid-cols-3 mt-10">
            {[
              ...
              <div
                key={index}
                className="bg-gray-50 border border-[#6366F1] rounded-xl p-5 shadow-sm"
              >
